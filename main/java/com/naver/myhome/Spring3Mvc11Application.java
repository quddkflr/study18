  ...
  @SpringBootApplication
    ...
    2. SpringBootApplications annotation이 포함하고 있는 세 가지 annotation은 다음과 같습니다.
    	...
    	(3) @EnableAutoConfiguration
    		  - @ComponentScan으로 빈이 등록된 이후, @EnbleAutoConfiguration를 통해 한 번 더 스캔되는데
...
@SpringBootApplication
public class Spring3Mvc11Application {

	public static void main(String[] args) {
		SpringApplication.run(Spring3Mvc11Application.class, args);
	}
